...
| **CC0** | Australian top-down terrain tiles (Poly Haven); earlier ground textures (ambientCG) | Yes — public domain, no attribution required; sources recorded in the Asset Register anyway |
