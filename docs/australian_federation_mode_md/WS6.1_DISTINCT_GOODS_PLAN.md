...
**Created:** 2026-07-15. **Status:** scoping complete; **Slices 1–2 SHIPPED 2026-07-15** — Copper, Coal and Sandalwood are live. The pattern is proven end-to-end (new goods-type + market + tile production + resource amplification; australia-only, classic byte-identical, no save bump, no engine code). **Next: the Gold and Wool promotions (slices 3–4).**
...
3. **Slice 3 — Gold** (promotion). **Scoped 2026-07-15 — the concrete retarget list (~20 spec refs + 1 code const):**
