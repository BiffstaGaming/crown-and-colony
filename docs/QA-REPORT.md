...
> **Auto-generated from CI** on 2026-09-06 at commit `cf39fdc` (save format **v76**). Do not hand-edit — this file is rewritten by [`scripts/generate-qa-report.py`](../scripts/generate-qa-report.py) on every CI run from the actual `dotnet test` results.
