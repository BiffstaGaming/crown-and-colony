...
> **Auto-generated from CI** on 2026-09-26 at commit `6c2b843` (save format **v76**). Do not hand-edit — this file is rewritten by [`scripts/generate-qa-report.py`](../scripts/generate-qa-report.py) on every CI run from the actual `dotnet test` results.
