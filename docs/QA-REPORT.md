...
> **Auto-generated from CI** on 2026-07-21 at commit `9c13f87` (save format **v75**). Do not hand-edit — this file is rewritten by [`scripts/generate-qa-report.py`](../scripts/generate-qa-report.py) on every CI run from the actual `dotnet test` results.
