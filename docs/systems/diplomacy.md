...
| **Last verified** | 2026-06-16 @ foreign-AI colony capture (1c-3f) |
...
- [x] **The AI *wages* war** (slice 1c-2 / 1c-3f): a foreign power at `War` attacks the human's units and **captures the human's undefended colonies** (`RunForeignPowerTurn`, on its own RNG stream — see [combat](combat.md)). Native raids off alarm shipped in 1b.
