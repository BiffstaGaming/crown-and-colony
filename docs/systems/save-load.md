...
| | |
|---|---|
| **Status** | Implemented (full game state: multi-player `Players[]`, per-player RNG streams, diplomacy stances/tensions, native settlements + interaction, ship repair, per-colony liberty, unit standing orders, colony build queues, Lost City Rumours, native land claims, treasure trains, custom-house export settings; save v28) |
| **Last verified** | 2026-06-17 @ custom house slice 1 (save v28: per-colony exports + auto-export mode) |
