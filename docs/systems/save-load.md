...
| | |
|---|---|
| **Status** | Implemented (full game state: multi-player `Players[]`, per-player RNG streams, diplomacy stances/tensions, native settlements + interaction, ship repair, per-colony liberty, unit standing orders, colony build queues, Lost City Rumours, native land claims, treasure trains; save v27) |
| **Last verified** | 2026-06-17 @ treasure trains (save v27: unit treasure amount) |
