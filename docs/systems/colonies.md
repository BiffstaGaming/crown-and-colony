...
| **Last verified** | 2026-06-16 @ colony screen with FreeCol terrain art in the 3×3 tiles grid (stage 1 of the visual rebuild) |
...
**The colony screen.** Click your colony to open it. The screen lays out the colony at a glance: a summary line (population, food toward the next colonist, defence bonus), the **3×3 grid of surrounding tiles** drawn in the **real FreeCol terrain art** (with the settlement sprite at the centre and a colonist sprite standing on each worked tile), each tile also showing, if worked, the colonist's good and yield (with a *Release*), or a *Work…* picker on a free tile — then the **buildings** (with worker slots), the **warehouse** (stored goods), the **colonists** here (move in/out, arm), and **construction**. It scrolls if the colony has a lot going on.
