...
| **Last verified** | 2026-06-16 @ full colony screen (3×3 tiles grid + buildings/warehouse/colonists/construction) |
...
**The colony screen.** Click your colony to open it. The screen lays out the colony at a glance: a summary line (population, food toward the next colonist, defence bonus), the **3×3 grid of surrounding tiles** with the colony at its centre — each tile showing its terrain and, if worked, the colonist's good and yield (with a *Release*), or a *Work…* picker on a free tile — then the **buildings** (with worker slots), the **warehouse** (stored goods), the **colonists** here (move in/out, arm), and **construction**. It scrolls if the colony has a lot going on.
