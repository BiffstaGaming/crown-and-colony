...
| | |
|---|---|
| **Status** | In progress — declaration + muster (7) + REF arrival/war combat (8). Win/lose (9-10) follow. |
| **Last verified** | 2026-06-19 @ REF arrival + War-of-Independence combat (`86d3c9v8k`) |
