...
| **Last verified** | 2026-06-20 @ P5 lake region tagging (rivers+lakes slice 1, 86d3b3qdx) |
...
| L4 Visual | Yes (map screen) | `VisualGoldenTests.MapView_SeededWorld_MatchesGolden` — golden `map-seed424242`, **unchanged** (regions are never rendered, so lake tagging moves no golden; default world byte-identical, no regen) | ✅ |
