...
| **Related systems** | [market](market.md) (sales), [units-movement](units-movement.md), [save-load](save-load.md) |
...
- [ ] Europe screen UI (dock, recruit, purchase); recruitment + immigration (P4 slice 4).
- [ ] Cargo capacity limits; ship combat/sinking; sail-time modifiers.
