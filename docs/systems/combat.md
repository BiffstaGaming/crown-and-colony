...
| | |
|---|---|
| **Status** | In development (Phase 5: slice 5b = the attack action, unit ownership, roles/equipment, brave defenders, the loser/winner outcomes, and native alarm; slice 5c = native settlement assault (attack / plunder / destroy); on-map combat UI = click an adjacent enemy/settlement to attack; **slice 1b = native-initiated raids** — braves attack the human's units on the natives' own RNG stream. Naval combat and foreign-European unit combat are the foreign-powers slice.) |
| **Last verified** | 2026-06-15 @ Phase 5 slice 1b (native raids) |
...
**Deviations from original / FreeCol (deliberate, 5b/5c/1b scope):**
