...
`game/tests/GameLogic.Tests/` — xUnit, mirrors this project's folder structure. **415 tests** (412 L1+L2 incl. 10 E2E journeys + 3 nightly soak), all green as of 2026-06-15 @ slice 1b. (Scene/visual L3+L4 live in the Godot project — see [presentation.md](presentation.md); 437 across all five layers.)
