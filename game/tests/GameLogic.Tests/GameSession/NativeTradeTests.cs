...
public class NativeTradeTests
{
    ...
    public void BuyBackAllowance_IsTransient_AddsNoSaveField()
    {
        ...
        Assert.Equal(73, SaveGame.CurrentVersion);   // and so adds no save field / version bump (its transience is exercised in BuyingSpendsTheAllowance_AndAFreshTurnClearsIt)
    }
