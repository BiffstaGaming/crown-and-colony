...
/// affected colony, by <see cref="GameSession.Game.DeclareIndependence(GameSession.Player)"/> (see
...
/// after <see cref="GameSession.Game.DeclareIndependence(GameSession.Player)"/> returns. Never saved or restored (the colony's reduced
