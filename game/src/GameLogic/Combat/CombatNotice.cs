...
/// <summary>
/// A record of one combat the human was involved in but did not initiate — today, a native brave raiding
/// a human unit during the AI phase of <see cref="GameSession.Game.EndTurn"/>. The human-driven attack paths
...
/// </remarks>
/// <param name="AttackerNationId">The native nation type id of the raiding attacker (e.g. <c>model.nationType.apache</c>).</param>
